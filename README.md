...
**NOTE:** `You may need to build the binaries for MediaPipe in order to successfully build the project, or to get the interaction with the webcam working on your system. Instructions for that can be found at https://github.com/homuler/MediaPipeUnityPlugin`

## 🛠️ Credits
- **[Filip Karlsson](https://github.com/Canaguia)** – Lightning Effects, Gesture Recognition, Game Design
- **[Martin Håkansson](https://github.com/silverknet)** – 3D Modeling, Art, Environmental Effects
- **[Lucas Åkesson](https://github.com/LukeTheDuke-afk)** – Environmental Effects, Post Processing, Audio
- **[David Giraldo](https://github.com/DavidGiraldoCode)** – Wind Effects, Volume Rendering, HLSL
